...
Here, I provide a pipeline to construt alternative conformations and calculate recombination frequency for plant mitogenomes.
...
Step 2. <br />
Use **recombination.pl** to construt four conformations for each repeat (two genomic and two alternative). Each conformation contains the repetitive sequence itself and 300 bp flanking sequences. <br />
